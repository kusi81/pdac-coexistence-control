...
**Manuscript title:** *A spatially grounded agent-based framework for coexistence-control of pancreatic cancer using food-medicine-homology compounds*
...
I am pleased to submit the above manuscript for consideration as a Research Article in *PLOS Computational Biology*. The work develops and analyzes a spatial agent-based model (ABM) of the pancreatic ductal adenocarcinoma (PDAC) tumor–stroma–immune ecosystem, and uses it to generate ranked, testable hypotheses for *controlling*—rather than eradicating—the tumor with low-toxicity, food-medicine-homology compounds. To my knowledge it is the first study to connect three research lines that are individually well developed but, as a systematic PubMed survey in the paper confirms, essentially never integrated: network pharmacology of food-medicine-homology compounds, wet-laboratory studies of herbal modulation of PDAC cancer-associated fibroblasts (CAFs), and agent-based modeling of the tumor microenvironment.
